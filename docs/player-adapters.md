...
The first two trained identities have [recorded development results](player-results.md), including improved reference loss, mixed blind preferences, a repetition failure, and the decoding regression check. They are experimental adapters; selecting one is not a guarantee of better writing.
